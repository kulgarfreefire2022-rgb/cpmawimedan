...
#text = """
#< [ Telegram AWIMEDAN ] > X < [ TikTok AWIMEDAN ] >"""[1:]
...
from AWIMEDAN import AWIMEDAN

__CHANNEL_USERNAME__ = "AWIMEDAN"
__GROUP_USERNAME__   = "AWIMEDAN"
    ...
    while True:
        ...
        while True:
            ...
            if service == 0: # Exit
                ...
                if status == 0:
                    print(Colorate.Horizontal(Colors.rainbow, 'SUCCESSFUL'))
                    print(Colorate.Horizontal(Colors.rainbow, f'INFO: IN ORDER TO TWEAK THIS ACCOUNT WITH AWIMEDAN.'))
                ...
                print(Colorate.Horizontal(Colors.rainbow, ' %100'))            
                console.print("[%] ﻿FAKE CLAN DRSSING MALE: ", end=None)
                ...
                print(Colorate.Horizontal(Colors.rainbow, ' %100'))            
                console.print("[%] ﻿REMOVE HEAD MALE: ", end=None)
